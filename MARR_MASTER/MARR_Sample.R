...
library(keras)
library(tensorflow)
suppressWarnings(source("MARR_Source_Functions.R"))
# -------------------------------------------------------------------------
# Load the master model saved in your working directory -------------------
model <- load_model_hdf5("MARR_Master_Model.h5")
# -------------------------------------------------------------------------
# =========================================================================
...
system.time(modelProcessing(pVal=0, modNew=F, iteration = "1_BaseModel"))
